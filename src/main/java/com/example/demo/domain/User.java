...
public class User extends BaseEntity implements Serializable {
  ...
  @Builder
  public User(final String account, final String name, final String password, final List<Comment> commentList,
  ...
  public String toString() {
    return "User{idx=" + this.idx + ", createdDate=" + this.createdDate + ", updatedDate=" + this.updatedDate
        + ", account=" + this.account + ", name=" + this.name + ", password=" + this.password + ", commentList.size()="
        + this.commentList.size() + ", articleList.size()=" + this.articleList.size() + "}";
  }
  ...
  public UserResDto toResDto() {
    return UserResDto.builder().idx(this.idx).name(this.name).build();
  }
}
