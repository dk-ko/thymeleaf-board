...
public class Board extends BaseEntity implements Serializable {
  ...
  public String toString() {
    return "Board{idx=" + this.idx + ", createdDate=" + this.createdDate + ", updatedDate=" + this.updatedDate
        + ", name=" + this.name + ", articleList.size()=" + this.articleList.size() + "}";
  }

  public BoardResDto toResDto() {
    return BoardResDto.builder().boardIdx(this.idx).name(this.name).build();
  }
}